...
<p style="width:100%; text-align:right;"><a href="index2.php?option=com_community_acl&task=changelog">`<?php echo _COMMUNITY_ACL_COMP_NAME . "` version history";?></a></p>	
...
&nbsp;&nbsp;&nbsp;&bull;&nbsp;id=30<br />
	...
	function about( $version ) {
		...
		<br />
			...
			if (check_core_file(JPATH_SITE.DS.'administrator'.DS.'modules'.DS.'mod_menu'.DS.'helper.php') < 1)
				 $msg .= 'Community ACL core patch in the `'.JPATH_SITE.DS.'administrator'.DS.'modules'.DS.'mod_menu'.DS.'helper.php'.'` file is not detected.<br/>';
				 
			if (check_core_file(JPATH_SITE.DS.'modules'.DS.'mod_mainmenu'.DS.'helper.php') < 1)
				 $msg .= 'Community ACL core patch in the `'.JPATH_SITE.DS.'modules'.DS.'mod_mainmenu'.DS.'helper.php'.'` file is not detected.<br/>';
				 
			if (check_core_file(JPATH_SITE.DS.'modules'.DS.'mod_mainmenu'.DS.'legacy.php') < 1)
				 $msg .= 'Community ACL core patch in the `'.JPATH_SITE.DS.'modules'.DS.'mod_mainmenu'.DS.'legacy.php'.'` file is not detected.<br/>';
				 
			if (check_core_file(JPATH_SITE.DS.'libraries'.DS.'joomla'.DS.'application'.DS.'module'.DS.'helper.php') < 1)
				 $msg .= 'Community ACL core patch in the `'.JPATH_SITE.DS.'libraries'.DS.'joomla'.DS.'application'.DS.'module'.DS.'helper.php'.'` file is not detected.<br/>';
	...
	function hacks(){
		...
		<tr>
			...
			<?php }?>
			</td><td style="width:auto;"><?php echo 'Community ACL core hack in the `'.JPATH_SITE.DS.'administrator'.DS.'modules'.DS.'mod_menu'.DS.'helper.php'.'` file is not detected.'.$not_writable;?></td>
		</tr>
		<?php } 
		...
		<tr>
			...
			?>
				<font color="#FF0000" style="font-weight:bold;">NOT WRITABLE!</font>
			<?php }?>
			</td><td style="width:auto;"><?php echo 'Community ACL core hack in the `'.JPATH_SITE.DS.'modules'.DS.'mod_mainmenu'.DS.'helper.php'.'` file is not detected.'.$not_writable;?></td>
		</tr>
		<?php } 
		...
		<tr>
			...
			?>
				<font color="#FF0000" style="font-weight:bold;">NOT WRITABLE!</font>
			<?php }?>
			</td><td style="width:auto;"><?php echo 'Community ACL core hack in the `'.JPATH_SITE.DS.'modules'.DS.'mod_mainmenu'.DS.'legacy.php'.'` file is not detected.'.$not_writable;?></td>
		</tr>
		<?php } 
	...
	function show_config( &$config, &$lists ) {
		...
		<script language="javascript" type="text/javascript">
			...
			//alert(jQuery('td#syncOptions').show());
				//var vis = (box.checked) ? "display" : "block";
				//document.getElementById(it).style.display = "display" : "block";
				if(it == 0)
		...
		<fieldset class="syncOptions"  style="display:block;">
		...
		?>
			<fieldset class="adminform">
				<legend><?php echo JText::_( 'Community Builder' ); ?></legend>
	...
	function set_functions( $id, &$lists, $option ) {
		...
		<table class="adminform">
			<tr>
				...
				<td align="left">
					&nbsp;&nbsp;
					<input type="button" name="add" class="button" value="Add" onclick="javascript: addRow('list_body');"  />	
				</td>
			</tr>
			<tr>
			...
			<thead>
				<tr> 
					...
					<th class="title" width="15%">
						...
						<input type="button" name="clear_all" class="button" value="<?php echo JText::_( 'Clear All' ); ?>" onclick="javascript: clearTable('list_body');"  />
					</th>	
					<th class="title" width="auto">&nbsp;						
					</th>				
				</tr>
...
function left_menu_header($title = _COMMUNITY_ACL_COMP_NAME, $icon = 'static'){
	...
	<img src="<?php echo substr_replace(JURI::root(), '', -1, 1);?>/images/blank.png" />
	</td></tr>
	<tr>
	...
	<tr>
		...
		<div id="content-pane" class="pane-sliders">
			<div class="panel">
				...
				<table class="adminlist">
					<tr>					
						<td width="16px"><img src="<?php echo substr_replace(JURI::root(), '', -1, 1);?>/includes/js/ThemeOffice/config.png" ></td>
						<td class="title">
					...
					<?php #VKS - Checks to see if Sychrionization is enabled, else it hids the submenu Synchronize									
						if ($config->synchronize) {?>
					<tr>					
						<td width="16px"><img src="<?php echo substr_replace(JURI::root(), '', -1, 1);?>/includes/js/ThemeOffice/controlpanel.png" ></td>
						<td class="title">
			...
			<div class="panel">
				...
				<table class="adminlist">
					<tr>					
						<td width="16px"><img src="<?php echo substr_replace(JURI::root(), '', -1, 1);?>/includes/js/ThemeOffice/language.png" ></td>
						<td class="title">
			...
			<div class="panel">
				...
				<table class="adminlist">
					<tr>					
						<td width="16px"><img src="<?php echo substr_replace(JURI::root(), '', -1, 1);?>/includes/js/ThemeOffice/users.png" ></td>
						<td class="title">
			...
			<div class="panel">				
				...
				<table class="adminlist">
					<tr>					
						<td width="16px"><img src="<?php echo substr_replace(JURI::root(), '', -1, 1);?>/includes/js/ThemeOffice/globe1.png" ></td>
						<td class="title">
			...
			<div class="panel">
				...
				<table class="adminlist">
					<tr>					
						<td width="16px"><img src="<?php echo substr_replace(JURI::root(), '', -1, 1);?>/includes/js/ThemeOffice/content.png" ></td>
						<td class="title">
							<a class="menu_link" href="index.php?option=<?php echo $option; ?>&task=list_groups"><?php echo JText::_( 'List of groups' ); ?></a>
						</td>
					</tr>
					<tr>
						<td width="16px"><img src="<?php echo substr_replace(JURI::root(), '', -1, 1);?>/includes/js/ThemeOffice/add_section.png" ></td>
						<td class="title">
			...
			<!--// <div class="panel">
				...
				<table class="adminlist">
					<tr>
						<td width="16px"><img src="<?php echo substr_replace(JURI::root(), '', -1, 1);?>/includes/js/ThemeOffice/document.png" ></td>
						<td class="title">
			...
			<div class="panel">
				...
				<table class="adminlist">					
					<tr>
						<td width="16px"><img src="<?php echo substr_replace(JURI::root(), '', -1, 1);?>/includes/js/ThemeOffice/credits.png" ></td>
						<td class="title">
					...
					<tr>
						<td width="16px"><img src="<?php echo substr_replace(JURI::root(), '', -1, 1);?>/includes/js/ThemeOffice/document.png" ></td>
						<td class="title">
							<a class="menu_link" href="index.php?option=<?php echo $option; ?>&task=disclaimer"><?php echo JText::_( 'Disclaimer / License' ); ?></a>
						</td>
					</tr>
					<tr>
						<td width="16px"><img src="<?php echo substr_replace(JURI::root(), '', -1, 1);?>/includes/js/ThemeOffice/help.png" ></td>
						<td class="title">
	...
	<tr><td style="height:8px; width:200px;background:url(<?php echo substr_replace(JURI::root(), '', -1, 1);?>/administrator/components/<?php echo $option; ?>/images/bottom_menu_bg.jpg) no-repeat top left ">
		<br /><img src="<?php echo substr_replace(JURI::root(), '', -1, 1);?>/images/blank.png" />
	</td></tr>
</table>
</div>
			</td>
