 ...
 */
	...
	$r4 = true === JFile::move( JPATH_ADMINISTRATOR.DS.'components'.DS.'com_jsecure'.DS.'sysplugin'.DS.'readme.jsecure.html',
	JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'readme.jsecure.html');
	...
	if ($r1 && $r2 && $r3 && $r4) {
		...
		JFile::delete(JPATH_ROOT.DS.'plugins'.DS.'system'.DS.'readme.jsecure.html');
