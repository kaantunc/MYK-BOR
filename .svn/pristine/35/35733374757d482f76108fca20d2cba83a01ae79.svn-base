            ...
            <div class="container">
                <div class="content">
                    <div class="form_element cf_heading">
                        <a href="ekler/ISCO-08.12-07-2011.docx" target="_blank">ISCO 08 Uluslararası Standart Meslek
                            Sınıflaması</a>
                    </div>
                    <div class="form_item">
                    ...
                    <div class="form_item">
                        <div class="form_element cf_textbox">
                            ...
                            <input class="cf_inputbox" maxlength="150"
                                   size="20" <?php echo($this->sektorSorumlusu ? "" : "disabled"); ?>
                                   id="referans_kodu" name="referans_kodu" type="text"
                                   value="<?php echo $standartBilgi['STANDART_KODU']; ?>"/>
                        </div>
                        <div class="cfclear">&nbsp;</div>
                    </div>
                    <?php
                        ...
                        <div class="form_item">
                            <div class="form_element cf_placeholder">
                                ...
                                <label class="cf_label"
                                       style="width:150px;"><?php if ($standartBilgi['REVIZYON'] != "00") { ?>Revizyon<?php } else { ?>Meslek Standardı<?php } ?>
                                    Durumu:</label>
                                <select id="revizyon_durum" class="cf_inputbox" name="revizyon_durum" title="" size="1"
                                        firstoption="1" firstoptiontext="Seçiniz"
                                        onchange="checkYeterlilikDurum(this)" <?php echo($this->sektorSorumlusu ? "" : "disabled"); ?>>
                    ...
                    <div class="form_item">
                        <div class="form_element cf_textbox">
                            ...
                            <input class="cf_inputbox date" maxlength="150"
                                   size="10" <?php echo($this->sektorSorumlusu ? "" : "disabled"); ?>
                                   id="yayin_tarihi" name="yayin_tarihi" type="text"
                                   value="<?php echo $standartBilgi["YAYIN_TARIHI"]; ?>"/>
                        </div>
                        <div class="cfclear">&nbsp;</div>
                    </div>
                    <div class="form_item">
                        <div class="form_element cf_textbox">
                            ...
                            <input class="cf_inputbox date" maxlength="150" size="10" id="onay_tarih" name="onay_tarih"
                                   type="text"
                                   value="<?php echo $standartBilgi['KARAR_TARIHI']; ?>" <?php echo($this->sektorSorumlusu ? "" : "disabled"); ?> />
                            /
                            <input class="cf_inputbox" maxlength=10 size="6" id="onay_sayi" name="onay_sayi" type="text"
                                   value="<?php echo $standartBilgi['KARAR_SAYI']; ?>" <?php echo($this->sektorSorumlusu ? "" : "disabled"); ?> />
                            <em style="color: red; font-size: 10px;">Revizyon ise revizyon onay tarihi girilmelidir
                                !</em>
                        </div>
                        <div class="cfclear">&nbsp;</div>
                    </div>
                    <div class="form_item">
                        <div class="form_element cf_textbox">
                            ...
                            <input class="cf_inputbox date" maxlength="150" size="10"
                                   id="goruse_cikma_tarihi" name="goruse_cikma_tarihi" type="text"
                                   value="<?php echo $taslakStandart["GORUSE_CIKMA_TARIHI"]; ?>" <?php echo($this->sektorSorumlusu ? "" : "disabled"); ?>/>
                        </div>
                        <div class="cfclear">&nbsp;</div>
                    </div>
                    <div class="form_item">
                        <div class="form_element cf_textbox" style="margin-left:32px;">
                            <input type="checkbox" name="tehlikeli_is_durum" id="tehlikeli_is_durum" value="1"
                                   style="float:left;" <?php echo($standartBilgi['TEHLIKELI_IS_DURUM'] == "1" ? "checked='checked'" : ""); ?> <?php echo($this->sektorSorumlusu ? "" : "disabled"); ?>/>
                            <label class="cf_label" style="margin: 0 0 0 10px; line-height: 13px;">Meslek Standardı
                                tehlikeli ve çok tehlikeli işler sınıfındadır.</label>
                        </div>
                        <div class="cfclear">&nbsp;</div>
                    </div>
                    <div class="form_item">
                    ...
                    <div class="form_item">
                        <div class="form_element cf_placeholder">
                            <div>
                                ...
                                <input style="float:left; height: 20px;" type="text" id="satirSayisiTextbox" size="3"
                                       value="1"><input style="float:left;" class="yeniKurulusEkleButton" type="button"
                                                        value="Adet Satır Ekle">
                            </div>
                        </div>
                        <div class="cfclear">&nbsp;</div>
                    </div>
                    <?php if ($this->standart_duzenleme_yetki) { ?>
                        <input type="button" value="Kaydet" class="save_section_ortak"/>
                    <?php } ?>
                </div>
            </div>
            <?php
...
<script>
    jQuery(document).ready(function () {
        ...
        if (isReadOnly)
            readOnly = "readOnly";
        jQuery(".save_section_ortak").live('click', function () {
            if (jQuery.trim(jQuery("#revizyon_durum").val()) == 14 && (jQuery("input[name=path_taslakPdf_0_1]").length == 0 || jQuery("input[name=path_taslakPdf_0_2]").length == 0 || jQuery("input[name=path_taslakPdf_0_3]").length == 0 || jQuery("input[name=path_taslakPdf_0_4]").length == 0 )) {

                alert("Resmi gazetede yayınlandı durumundan önce bütün versiyon dosyalarını yüklemek zorundasınız.");
                return false;
            }

            parameters5 = 'standart_id=' + '<?php echo $this->standart_id;?>' +
            ...
            saveSection('section5', parameters5);

            setTimeout(function () {
                parameters1 = 'standart_id=' + '<?php echo $this->standart_id;?>' +
                ...
                saveSection('section1', parameters1);
            }, 1000);
        ...
        jQuery("#save_section1").live('click', function () {
        ...
        jQuery("#save_section5").live('click', function () {
            parameters = 'standart_id=' + '<?php echo $this->standart_id;?>' +
                '&path_taslakPdf_0_1=' + (jQuery("input[name=path_taslakPdf_0_1]").length > 0 ? jQuery("input[name=path_taslakPdf_0_1]").val() : "") +
                '&path_taslakPdf_0_2=' + (jQuery("input[name=path_taslakPdf_0_2]").length > 0 ? jQuery("input[name=path_taslakPdf_0_2]").val() : "") +
                '&path_taslakPdf_0_3=' + (jQuery("input[name=path_taslakPdf_0_3]").length > 0 ? jQuery("input[name=path_taslakPdf_0_3]").val() : "") +
    ...
    function belgelerInit(tableName) {
        ...
        for (var i = 1; i <= rowCount; i++) {
            ...
            jQuery("input[name='taslakPdf_0_submitBtn_1']").removeAttr("disabled");
        }
