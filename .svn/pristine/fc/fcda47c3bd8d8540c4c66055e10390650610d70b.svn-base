...
defined( '_JEXEC' ) or die('Sınırlı Erişim');
...
DEFINE('_KUNENA_EMOTICONS_NEW_SMILEY', 'Yeni Gülen Yüz');
...
DEFINE('_KUNENA_DISCUSSIONS', 'Tartışmalar');
...
// view.php
DEFINE('_VIEW_DISABLED', 'Herkesin yazı yazması yönetici tarafından engellenmiştir.');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_BOLD', 'Kalın metin: [b]metin buraya[/b]');
DEFINE('_KUNENA_EDITOR_HELPLINE_ITALIC', 'Eğik metin: [i]metin buraya[/i]');
DEFINE('_KUNENA_EDITOR_HELPLINE_UNDERL', 'Altı çizili metin: [u]metin buraya[/u]');
DEFINE('_KUNENA_EDITOR_HELPLINE_STRIKE', 'Strikethrough Text: [strike]metin buraya[/strike]');
DEFINE('_KUNENA_EDITOR_HELPLINE_SUB', 'Subscript Text: [sub]metin buraya[/sub]');
DEFINE('_KUNENA_EDITOR_HELPLINE_SUP', 'Superscript Text: [sup]metin buraya[/sup]');
DEFINE('_KUNENA_EDITOR_HELPLINE_QUOTE', 'Alıntı metni: [quote]metin buraya[/quote]');
DEFINE('_KUNENA_EDITOR_HELPLINE_CODE', 'Kod gmrünümü: [code]kod[/code]');
DEFINE('_KUNENA_EDITOR_HELPLINE_UL', 'Sıralamasız liste: [ul] [li]metin buraya[/li] [/ul] - Tip: Liste, liste ögelerini içermelidir');
DEFINE('_KUNENA_EDITOR_HELPLINE_OL', 'Sıralı liste: [ol] [li]metin buraya[/li] [/ol] - Tip: Liste, liste ögelerini içermelidir');
DEFINE('_KUNENA_EDITOR_HELPLINE_LI', 'Liste ögesi: [li] liste ögesi [/li]');
DEFINE('_KUNENA_EDITOR_HELPLINE_ALIGN_LEFT', 'Sola hizala: [left]metin buraya[/left]');
DEFINE('_KUNENA_EDITOR_HELPLINE_ALIGN_CENTER', 'Ortaya hizala: [center]metin buraya[/center]');
DEFINE('_KUNENA_EDITOR_HELPLINE_ALIGN_RIGHT', 'Sağa hizala: [right]metin buraya[/right]');
...
DEFINE('_KUNENA_EDITOR_HELPLINE_IMAGELINKURL', 'Resim bağlantısı: Resim bağlantısının URLsi');
DEFINE('_KUNENA_EDITOR_HELPLINE_IMAGELINKAPPLY', 'Resim bağlantısı: Apply image link');
DEFINE('_KUNENA_EDITOR_HELPLINE_LINK', 'Bağlantı: [url=http://www.joomlatr.org/]bu bir bağlantıdır[/url]');
DEFINE('_KUNENA_EDITOR_HELPLINE_LINKURL', 'Bağlantı: Bağlantının URLsi');
DEFINE('_KUNENA_EDITOR_HELPLINE_LINKTEXT', 'Bağlantı: Metin / Bağlantının açıklaması');
DEFINE('_KUNENA_EDITOR_HELPLINE_LINKAPPLY', 'Bağlantı: Apply link');
DEFINE('_KUNENA_EDITOR_HELPLINE_HIDE','Saklı metin: [hide]saklanacak metin[/hide] - ziyaretçilerden gizlenecek metin');
DEFINE('_KUNENA_EDITOR_HELPLINE_SPOILER', 'Spoiler: Text is only shown after you click the spoiler');
DEFINE('_KUNENA_EDITOR_HELPLINE_COLOR', 'Renk: [color=#FF6600]metin buraya[/color]');
DEFINE('_KUNENA_EDITOR_HELPLINE_FONTSIZE', 'Metin boyutu: [size=1]metin boyutu[/size] - Tip: 1 ile 5 arası boyut seçin');
DEFINE('_KUNENA_EDITOR_HELPLINE_FONTSIZESELECTION', 'Metin boyutu: Metin boyutunu seçin, metni işaretleyin ve butona basın');
DEFINE('_KUNENA_EDITOR_HELPLINE_EBAY', 'eBay: [ebay]ItemId[/ebay]');
DEFINE('_KUNENA_EDITOR_HELPLINE_VIDEO', 'Video: sağlayıcıyı seçin veya bağlantı girin - modus');
