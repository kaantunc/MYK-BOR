...
Kurum/kuruluşa ilişkin gerekli bilgiler aşağıdaki bölümlerde izah edilmiştir.";
                ...
                if ($form == 3)
                {
                    $belgeYazi = "Mesleki Yeterlilik Kurumu Sınav, Ölçme, Değerlendirme ve Belgelendirme Yönetmeliğinde belirtilen şartları karşıladığımızı beyan eder ve anılan Yönetmelik hükümleri kapsamında aşağıda sayılan ulusal yeterlilik(ler)de yetkilendirilmiş belgelendirme kuruluşu olma talebimizin değerlendirilmesini arz ederiz.";
                    $pdf->Cell(0, 10, "", 0, 1, 'C');
